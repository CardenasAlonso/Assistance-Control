...
public class ManageTeacherUseCaseImpl {
    ...
    // --- MAPPER ---
    private TeacherResponseDto mapToDto(TeacherEntity saved) {
        return new TeacherResponseDto(
                saved.getId(), saved.getFirstName(), saved.getLastName(), 
                saved.getDocumentNumber(), saved.getEmail(), saved.getPhone(), 
                saved.getSpecialtiesJson(), saved.getStatus(), saved.getHireDate()
        );
    }
}